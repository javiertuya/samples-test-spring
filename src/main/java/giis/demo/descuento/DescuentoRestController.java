...
/**
 * Controlador REST para obtener los descuentos bajo una url /api/decuentos?edad=xxx (edad es opcional, si no
 * se indica, se obtienen todos). No realiza validaciones de los parametros.
 */
@RestController
