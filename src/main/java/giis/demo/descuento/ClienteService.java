...
public class ClienteService {
	...
	/**
	 * La obtencion de la lista de promociones consulta los clientes del repositorio y las promociones del api de
	 * marketing, devolviendo para cada cliente el codigo de promocion correspondiente a su pais.
	 * 
	 * Si todos los datos estuvieran en la misma base de datos, esto se implementaria directamente como una query
	 * en el repositorio, pero en este caso la unica forma de acceder a los datos de marketing es a traves de su
	 * api.
	 */
