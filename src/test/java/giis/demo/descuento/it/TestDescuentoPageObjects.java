...
public class TestDescuentoPageObjects {
	...
	/**
	 * Salvo la ejecucion de cada paso y la localizacion de la pagina bajo test en el setup, el resto del codigo
	...
	/**
	 * La ejecucion de un paso ilustra el uso de las acciones del Page Object. Se puede apreciar como se
	 * simplifica el codigo del test al encapsular todas las operaciones realizadas por selenium en el Page Object
	 */
